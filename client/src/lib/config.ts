...
export const WEEKEND_HOLIDAY_CONFIG = {
  /** 割増率（0.1 = 10%増し） */
  surchargeRate: 0.1,

  /** 表示ラベル */
  label: '土日祝加算（基本料金10%増）',
};
...
export const OMAKASE_PLAN_CONFIG = {
  /** 基本料金（50kmまで） */
  baseFee: 8000,
  ...
  /** 説明 */
  description: '作業員が2名で伺い、搬入搬出作業をすべてお任せできるプラン',
};
...
export const UI_DISPLAY_CONFIG = {
  /** 積み置き料金に関する注意メッセージを表示するか */
  SHOW_TSUMIOKI_MESSAGE: false,
};
