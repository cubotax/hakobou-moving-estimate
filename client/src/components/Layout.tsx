                ...
                <footer className="bg-black text-white py-8 px-4">
                    <div className="max-w-2xl mx-auto px-4">
                        <div className="flex flex-col sm:flex-row sm:justify-center items-start sm:items-center gap-4 sm:gap-10 text-sm text-gray-400 mb-4">
                            <a href="https://hakobou.com/tokushoho" className="hover:text-white flex items-center gap-2">
                            ...
                            <a href="https://hakobou.com/company" className="hover:text-white flex items-center gap-2">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="10" cy="10" r="9" stroke="#FFE14D" strokeWidth="2" />
                                    <path d="M8 6L12 10L8 14" stroke="#FFE14D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                            ...
                            <a href="https://hakobou.com/privacy" className="hover:text-white flex items-center gap-2">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="10" cy="10" r="9" stroke="#FFE14D" strokeWidth="2" />
                                    <path d="M8 6L12 10L8 14" stroke="#FFE14D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                            ...
                            <a href="https://hakobou.com/contact" className="hover:text-white flex items-center gap-2">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="10" cy="10" r="9" stroke="#FFE14D" strokeWidth="2" />
                                    <path d="M8 6L12 10L8 14" stroke="#FFE14D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
