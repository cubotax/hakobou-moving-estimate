...
export function AddressForm() {
  ...
  const [pickupPostalAddress, setPickupPostalAddress] = useState<string | null>(
    null
  );
    ...
    try {
      ...
      if (result.isValid) {
        ...
        setPickupValidationError(
          result.errorMessage || "住所が見つかりませんでした"
        );
            ...
            <div className="grid gap-4 max-w-md mx-auto">
              ...
              {!!pickupValidated && (
                <div className="flex items-center gap-2 p-3 bg-[oklch(0.95_0.1_145)] rounded-xl border-2 border-[oklch(0.7_0.15_145)]">
                  ...
                  <span className="text-sm font-bold text-[oklch(0.4_0.1_145)]">
                    確認済み
                  </span>
                </div>
              )}
              ...
              {!!pickupPostalAddress && (
                <div className="p-4 bg-[oklch(0.95_0.1_145)] rounded-xl border-2 border-[oklch(0.7_0.15_145)]">
                  <div className="flex items-center gap-2 mb-2">
                    <CheckCircle2 className="w-5 h-5 text-[oklch(0.5_0.15_145)]" />
                    <span className="font-bold text-[oklch(0.4_0.1_145)]">
                      取得した住所
                    </span>
                  </div>
